...
Room::Room(unsigned int id, std::string name, unsigned int  maxPlayers, unsigned int timePerQuestion, unsigned int questionCount, std::string createdBy) : m_metadata{ id, name, maxPlayers, timePerQuestion, 1, questionCount, createdBy } {}

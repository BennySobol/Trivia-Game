...
enum class MessageCode{ ERROR_MESSAGE = 'E', LOGIN = 'L', SIGNUP = 'S', STATISTICS = 'T', LOGOUT='O', CREATE_ROOM = 'C', JOIN_ROOM = 'J', GET_ROOMS = 'G', GET_PLAYERS_IN_ROOM = 'P', CLOSE_ROOM = '~', START_GAME = 'A', GET_ROOM_STATE = '?', LEAVE_ROOM = 'V'};
